...
__all__ = [
    'SPSInterjection', 'IInternetSecurityManager', 'SREStreamStart',
    'SpeechEngineConfidence', 'SP_VISEME_4',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechAllElements',
    'ISpeechPhraseReplacements', 'WAVEFORMATEX',
    'SpeechGrammarTagWildcard', 'DISPID_SPRDisplayAttributes',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechLexiconType',
    'SPINTERFERENCE_TOOQUIET', 'eLEXTYPE_PRIVATE9', 'SPPS_Noun',
    'SVEVoiceChange', 'DISPID_SBSRead', 'SP_VISEME_7',
    'DISPID_SLGetGenerationChange', 'SPRST_ACTIVE', 'SECFDefault',
    'ISpeechFileStream', 'DISPID_SRGIsPronounceable',
    'DISPID_SDKOpenKey', 'SPPS_RESERVED3', 'DISPID_SGRSTPropertyName',
    'SPSHT_Unknown', 'SRCS_Disabled', 'DISPID_SPRText',
    'SSTTWildcard', 'SGDSActiveWithAutoPause', 'SGDSInactive',
    'STCAll', 'SpeechFormatType', 'SVSFParseMask',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SECHighConfidence',
    'eLEXTYPE_PRIVATE3', 'SITooQuiet', 'DISPID_SPRuleConfidence',
    'ISpeechRecoContext', 'DISPID_SWFEChannels',
    'SpUnCompressedLexicon', 'IInternetSecurityMgrSite',
    'ISpStreamFormatConverter', 'SPEI_SR_RETAINEDAUDIO', 'SASStop',
    'SPEI_INTERFERENCE', 'SPWT_PRONUNCIATION', 'SP_VISEME_21',
    'DISPID_SRCEEnginePrivate', 'SPSSuppressWord', 'SpCustomStream',
    'SPDATAKEYLOCATION', 'DISPID_SPPChildren', 'SP_VISEME_1',
    'SPBOOKMARKOPTIONS', 'SPGRAMMARWORDTYPE', 'SECFEmulateResult',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTCCITT_ALaw_22kHzStereo',
    'SGLexical', 'SVF_None', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SLPPhoneIds', 'SPBO_PAUSE', 'SRAInterpreter',
    'SVEPhoneme', 'SAFT48kHz16BitMono', 'DISPID_SRSetPropertyNumber',
    'DISPID_SpeechAudio', 'ISpSerializeState', 'SLODynamic',
    'DISPID_SRCEventInterests', 'SPAR_Low', 'SPAO_RETAIN_AUDIO',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPPConfidence', 'SSTTDictation',
    'SVSFIsFilename', 'SPINTERFERENCE_TOOLOUD', 'SRTReSent',
    'DISPID_SOTCategory', 'ISpeechRecoResult', 'SSFMOpenForRead',
    'SAFT44kHz8BitStereo', 'DISPID_SRRGetXMLErrorInfo', 'SGSDisabled',
    'DISPID_SVSRunningState', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SRRTStreamTime', 'SpeechCategoryRecoProfiles',
    'SPSEMANTICFORMAT', 'SPRS_ACTIVE', 'ISpeechBaseStream',
    'eLEXTYPE_PRIVATE6', 'DISPID_SpeechGrammarRules',
    'SpeechDisplayAttributes', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVP_5',
    'DISPID_SPEPronunciation', 'SpeechVisemeType', 'SpObjectToken',
    'DISPID_SVSVisemeId', 'SPEI_ADAPTATION',
    'ISpeechRecoResultDispatch', 'SRSInactiveWithPurge',
    'ISequentialStream', 'DISPID_SPEDisplayText', 'DISPID_SPPParent',
    'SP_VISEME_19', 'SAFT22kHz16BitMono', 'DISPID_SGRAddState',
    'SP_VISEME_9', 'SAFT48kHz8BitMono', 'SDTProperty', 'SPSModifier',
    'DISPID_SpeechRecoResult', 'DISPID_SpeechPhraseElements',
    'SAFT11kHz8BitStereo', 'SPTEXTSELECTIONINFO',
    'ISpPhoneticAlphabetConverter', 'DISPID_SGRSTType', 'SPEI_MIN_SR',
    'DISPID_SLPLangId', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRCRetainedAudio',
    'DISPID_SRCEInterference', 'DISPID_SRDisplayUI',
    'eLEXTYPE_PRIVATE19', 'SSSPTRelativeToEnd', 'SPRECOGNIZERSTATUS',
    'SPPS_RESERVED2', 'DISPID_SVSpeakCompleteEvent',
    'SpeechDiscardType', 'SPEI_UNDEFINED',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechLexicon', 'DISPID_SpeechPhraseRules',
    'DISPID_SPARecoResult', 'SPDKL_DefaultLocation',
    'DISPID_SOTDisplayUI', 'SpeechCategoryPhoneConverters',
    'SGRSTTRule', 'DISPID_SpeechXMLRecoResult', 'SSFMOpenReadWrite',
    'SAFT24kHz8BitMono', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_RESERVED3', 'SAFT12kHz16BitMono',
    'DISPID_SRSetPropertyString', 'SAFT12kHz16BitStereo',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_RESERVED2',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPPId',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SDKSetLongValue',
    'SVSFVoiceMask', 'SPCONTEXTSTATE',
    'SSSPTRelativeToCurrentPosition',
    'DISPID_SRCEPropertyNumberChange', 'SpeechGrammarState',
    'SECFIgnoreKanaType', 'SPEVENT', 'DISPID_SOTCDefault', 'SVP_20',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SpeechAudioStatus',
    'ISpeechPhraseInfoBuilder', 'DISPID_SFSOpen', 'SASRun',
    'DISPID_SABufferNotifySize', 'SRADynamic', 'ISpeechMMSysAudio',
    'DISPID_SPRs_NewEnum', 'SPEI_PHRASE_START', 'ISpeechPhraseRules',
    'eWORDTYPE_DELETED', 'DISPID_SOTDataKey', 'SpMMAudioOut',
    'Speech_Default_Weight', 'DISPID_SMSSetData',
    'ISpeechGrammarRule', 'SPWT_DISPLAY', 'DISPID_SRGState',
    'DISPID_SLWsCount', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPLOADOPTIONS', 'SpeechRecoContextState', 'ISpeechCustomStream',
    'DISPID_SRIsShared', 'SPEI_TTS_BOOKMARK', 'SPEI_HYPOTHESIS',
    'SPEI_REQUEST_UI', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPILanguageId', 'SAFT8kHz8BitStereo', 'SVP_16',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SPCLangId',
    'DISPID_SPRulesItem', 'SAFT32kHz8BitStereo',
    'DISPID_SPIAudioSizeBytes', 'SpeechPropertyResourceUsage',
    'DISPID_SPPValue', 'SGSEnabled', 'DISPID_SVIsUISupported',
    'SBONone', 'DISPID_SVStatus', 'SpeechPropertyResponseSpeed',
    'ISpeechAudioStatus', 'DISPID_SRGDictationUnload',
    'DISPID_SVEStreamStart', 'DISPID_SMSGetData',
    'SREPropertyNumChange', 'STCLocalServer',
    'DISPID_SpeechMemoryStream', 'DISPID_SRCRequestedUIType',
    'DISPID_SVSInputSentenceLength', 'ISpeechRecoResultTimes',
    'SWPUnknownWordUnpronounceable', 'ISpeechDataKey',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechObjectTokens',
    'ISpLexicon', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechAudioBufferInfo', 'SP_VISEME_10',
    'DISPID_SVGetVoices', 'DISPID_SRGId', 'SPCS_ENABLED',
    'Speech_Max_Word_Length', 'SPPHRASEREPLACEMENT', 'SDTAudio',
    'DISPID_SRGetFormat', 'DISPID_SGRSAddSpecialTransition',
    'SREStreamEnd', 'tagSPPROPERTYINFO', 'DISPID_SWFEAvgBytesPerSec',
    'SPAUDIOOPTIONS', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRCreateRecoContext', 'DISPID_SLWs_NewEnum',
    'SpeechPropertyHighConfidenceThreshold', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SGRSTNextState', 'SPPS_RESERVED4', 'SPEI_TTS_PRIVATE',
    'SpeechCategoryAppLexicons', 'SAFTGSM610_11kHzMono', 'LONG_PTR',
    'SRAExport', 'SSTTTextBuffer', 'DISPID_SPRuleParent',
    'SPLO_DYNAMIC', 'STCInprocServer', 'DISPID_SVGetProfiles',
    'ISpShortcut', 'SPSHORTCUTPAIR', 'SpeechRecoProfileProperties',
    'SPEI_SOUND_END', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRCRetainedAudioFormat', 'SPGS_DISABLED',
    'DISPID_SPPNumberOfElements', 'ISpeechResourceLoader',
    'SPVPRI_ALERT', 'SPRECOSTATE', 'SVP_11', 'SREStateChange',
    'SpWaveFormatEx', 'DISPID_SRAudioInput',
    'DISPID_SGRSTPropertyValue',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRRSaveToMemory', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SDKDeleteValue', 'ISpMMSysAudio', 'DISPID_SVSPhonemeId',
    'SAFT8kHz16BitStereo', 'DISPID_SDKCreateKey', 'DISPID_SVVolume',
    'DISPID_SRCEPropertyStringChange', 'ISpeechLexiconPronunciation',
    'SVEAudioLevel', 'DISPID_SVResume', 'DISPID_SPEAudioSizeTime',
    'DISPID_SMSAMMHandle', 'SPPS_NotOverriden', 'SPXRO_SML',
    'SGLexicalNoSpecialChars', 'DISPID_SRGDictationSetState',
    'SITooFast', 'SAFT32kHz16BitMono', 'SITooLoud',
    'SAFT44kHz16BitMono', 'SPINTERFERENCE_LATENCY_WARNING', 'SPWORD',
    'SVP_15', 'ISpPhraseAlt', 'DISPID_SpeechWaveFormatEx',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SpeechFileStream',
    'SAFT12kHz8BitMono', 'SVF_Stressed', 'SpeechCategoryVoices',
    'SVSFIsXML', 'SPSLMA', 'SP_VISEME_2', 'SPVPRI_NORMAL',
    'SPCT_SUB_DICTATION', 'DISPID_SVSpeakStream',
    'SPXMLRESULTOPTIONS', 'DISPID_SGRsDynamic', 'SpMMAudioEnum',
    'SAFTGSM610_44kHzMono', 'SPBO_NONE', 'DISPID_SOTs_NewEnum',
    'SpeechVoiceEvents', 'SPAUDIOBUFFERINFO', 'ISpRecognizer2',
    'SVESentenceBoundary', 'IEnumSpObjectTokens', 'DISPIDSPRG',
    'SVP_7', 'DISPID_SVGetAudioOutputs', 'DISPID_SLAddPronunciation',
    'SpeechPropertyNormalConfidenceThreshold', 'SPEI_RECOGNITION',
    'SP_VISEME_5', 'SAFT44kHz8BitMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SP_VISEME_11',
    'SECFIgnoreWidth', 'DISPID_SPPs_NewEnum', 'SpeechTokenValueCLSID',
    'SECLowConfidence', 'DISPIDSPTSI',
    'DISPID_SPIAudioStreamPosition',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFTCCITT_uLaw_8kHzMono', 'SpObjectTokenCategory',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SRProfile',
    'DISPID_SOTMatchesAttributes', 'SVP_10', 'DISPID_SRRTTickCount',
    'SECFIgnoreCase', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SAVolume',
    'SGRSTTTextBuffer', 'SREHypothesis', 'SpNotifyTranslator',
    'DISPID_SPIElements', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SABIMinNotification', 'eLEXTYPE_PRIVATE11',
    'ISpeechPhraseReplacement', 'SpeechDictationTopicSpelling',
    'SPINTERFERENCE_NONE', 'eLEXTYPE_PRIVATE4', 'SpeechMicTraining',
    'DISPID_SWFEBlockAlign', 'SGDSActive', 'DISPID_SABIEventBias',
    'SpeechVoiceSpeakFlags', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRRDiscardResultInfo', 'Speech_StreamPos_Asap',
    'DISPID_SLGenerationId', 'ISpeechLexiconWords', 'DISPID_SOTCId',
    'SAFT16kHz8BitStereo', 'SPAS_RUN', 'DISPID_SRCERecognition',
    'ISpeechGrammarRuleState', 'DISPID_SRSSupportedLanguages',
    'DISPID_SpeechGrammarRule', 'SVP_1', 'DISPID_SDKSetStringValue',
    'SpeechVoicePriority', 'DISPID_SAFType', 'SP_VISEME_3',
    'ISpNotifyTranslator', 'ISpRecoResult', 'SVP_9',
    'SPSERIALIZEDPHRASE', 'SVSFNLPSpeakPunc',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRRecognizer',
    'SpeechVisemeFeature', 'ISpeechVoiceStatus',
    'DISPID_SpeechObjectTokenCategory',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SDKGetlongValue',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRState',
    'SAFTCCITT_ALaw_22kHzMono', 'SVEViseme',
    'ISpeechPhraseProperties', 'SVEAllEvents',
    'DISPID_SpeechVoiceStatus', 'SDTReplacement',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SPPsCount',
    'SVEStartInputStream', 'DISPID_SRGSetTextSelection', 'SPCT_SLEEP',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_LETTERTOSOUND', 'SAFT22kHz16BitStereo',
    'DISPID_SRCEBookmark', 'DISPID_SpeechPhraseProperties',
    'STSF_CommonAppData', 'SPLO_STATIC', 'ISpEventSink',
    'SPEI_TTS_AUDIO_LEVEL', 'SRERequestUI',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'Speech_Max_Pron_Length',
    'DISPID_SRGRecoContext', 'DISPID_SpeechPhraseProperty',
    'SPEI_MIN_TTS', 'SPSHT_EMAIL', 'SPAUDIOSTATE',
    'DISPID_SLPSymbolic', 'DISPID_SLRemovePronunciation',
    'ISpeechGrammarRuleStateTransition', 'SpeechStreamFileMode',
    'DISPID_SGRs_NewEnum', 'DISPID_SVEWord',
    'DISPID_SPERequiredConfidence', 'SDKLCurrentUser',
    'DISPID_SOTCSetId', 'eLEXTYPE_USER_SHORTCUT', 'DISPID_SBSSeek',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVSLastBookmark',
    'SP_VISEME_12', 'ISpRecoContext', 'SpeechTokenKeyAttributes',
    'DISPID_SVEAudioLevel', 'SPEI_END_INPUT_STREAM', 'SRTEmulated',
    'SpResourceManager', 'SpeechAudioFormatType',
    'DISPID_SpeechPhraseRule', 'ISpPhoneticAlphabetSelection',
    'SVSFParseSapi', 'DISPID_SRCEStartStream',
    'DISPID_SPEAudioSizeBytes',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPDKL_LocalMachine',
    'SPEI_RECO_OTHER_CONTEXT', 'SPBO_TIME_UNITS', 'SWTAdded',
    'SPEI_RESERVED6', 'SPLEXICONTYPE', 'DISPID_SBSWrite', 'SPPS_Verb',
    'eLEXTYPE_RESERVED9', 'SFTInput', 'SPGS_EXCLUSIVE',
    'DISPID_SRGCommit', 'SRSActiveAlways', 'SPEI_START_SR_STREAM',
    'SRAORetainAudio', 'SVEBookmark', 'SGRSTTEpsilon',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpeechBookmarkOptions',
    'SPEI_VOICE_CHANGE', 'DISPID_SVSkip', 'SPVPRIORITY',
    'ISpeechAudio', 'SAFT22kHz8BitStereo', 'SDTRule',
    'DISPID_SVPause', 'SPEI_MAX_SR', 'SAFT16kHz8BitMono', 'SRSEDone',
    'DISPID_SRStatus', 'SpeechWordPronounceable',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRCEFalseRecognition',
    'SVSFPersistXML', 'SRTAutopause', 'eLEXTYPE_APP',
    'SpeechRecognizerState', 'SDTAlternates',
    'DISPID_SRCEPhraseStart', 'eLEXTYPE_PRIVATE12', 'ISpRecoGrammar2',
    'DISPID_SGRsFindRule', 'DISPID_SGRSTWeight', 'SPEVENTSOURCEINFO',
    'SAFT8kHz8BitMono', 'ISpObjectTokenCategory', 'DISPID_SVSpeak',
    'DISPID_SOTSetId', 'ISpeechGrammarRules',
    'DISPID_SVSLastBookmarkId', 'ISpeechPhraseElement',
    'SpeechDataKeyLocation', 'SpeechTokenKeyFiles', 'ISpeechLexicon',
    'SDKLDefaultLocation', 'SRSActive', 'SPSNotOverriden',
    'DISPID_SpeechRecoContext', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPEsItem', 'DISPID_SRGetRecognizers', 'DISPID_SPPsItem',
    'DISPID_SPAStartElementInResult', 'SPFM_NUM_MODES',
    'eLEXTYPE_PRIVATE1', 'DISPID_SGRSTText', 'SREPhraseStart',
    ...
    'DISPID_SPIEngineId', 'SASPause', 'SAFT24kHz8BitStereo',
    'SPFM_OPEN_READONLY', 'DISPID_SGRSTRule', 'eLEXTYPE_PRIVATE20',
    'SAFTNonStandardFormat', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SRCSetAdaptationData', 'SVSFParseSsml',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SLWWord',
    'SPRS_INACTIVE', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SpeechMMSysAudio', 'ISpeechTextSelectionInformation',
    'SINoSignal', 'SP_VISEME_6', 'ISpeechPhraseRule',
    'SPRST_NUM_STATES', 'SPCATEGORYTYPE', 'eLEXTYPE_PRIVATE16',
    'SGDSActiveUserDelimited', 'SRERecognition', 'SpeechRunState',
    'DISPID_SRCPause', 'DISPID_SASFreeBufferSpace',
    'SAFTADPCM_8kHzMono', 'DISPID_SGRSTPropertyId',
    'DISPID_SLWLangId', 'DISPID_SRRGetXMLResult',
    'ISpeechObjectTokenCategory', 'DISPID_SASState',
    'SPSTREAMFORMATTYPE', 'SpeechTokenKeyUI', 'DISPID_SRRTLength',
    'SVSFParseAutodetect', 'DISPID_SpeechPhoneConverter',
    'SWTDeleted', 'SP_VISEME_15', 'SFTSREngine', 'SRADefaultToActive',
    'SVPOver', 'eLEXTYPE_RESERVED7', 'SRAImport', 'SPPHRASERULE',
    'DISPID_SPPName', 'DISPID_SVSInputWordLength',
    'DISPID_SRIsUISupported', 'SDTLexicalForm', 'SITooSlow',
    'SVEWordBoundary', 'DISPID_SOTRemove',
    'SpeechAudioFormatGUIDText', 'SpeechCategoryRecognizers',
    'SDA_One_Trailing_Space', 'SRCS_Enabled', 'SPINTERFERENCE',
    'SDA_No_Trailing_Space', 'ISpAudio', 'DISPID_SVAudioOutput',
    'SpeechSpecialTransitionType', 'SVP_19', 'SPSHT_NotOverriden',
    'SPPHRASE', 'DISPID_SVSLastResult', 'DISPID_SPPEngineConfidence',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPACommit',
    'ISpRecognizer3', 'DISPID_SPRuleFirstElement',
    'DISPID_SRGCmdLoadFromMemory', 'ISpeechRecognizerStatus',
    'SpAudioFormat', 'SPRULE', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SGRsCommitAndSave', 'DISPID_SpeechAudioFormat',
    '_ISpeechVoiceEvents', 'DISPID_SVESentenceBoundary',
    'DISPID_SVEViseme', 'SPSERIALIZEDRESULT', 'SpeechRecognitionType',
    'SAFTNoAssignedFormat', 'SPPS_RESERVED1', 'ISpeechPhoneConverter',
    'DISPID_SOTGetStorageFileName', 'SSFMCreateForWrite', 'SpStream',
    'ISpRecoCategory', 'eLEXTYPE_PRIVATE15', 'ISpNotifySource',
    'DISPID_SPIGetDisplayAttributes', 'SLOStatic',
    'DISPID_SpeechRecoResult2', 'SVF_Emphasis', 'SPEI_SOUND_START',
    'SpSharedRecoContext', 'SPEI_RESERVED1',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPXRO_Alternates_SML',
    'DISPID_SASNonBlockingIO', 'DISPID_SRCERecognizerStateChange',
    'SVP_21', 'DISPID_SWFESamplesPerSec', 'ISpRecoContext2',
    'DISPID_SRCBookmark', 'DISPID_SWFEExtraData', 'SGRSTTDictation',
    'SPDKL_CurrentUser', 'tagSTATSTG', 'DISPID_SVEPhoneme',
    'DISPID_SRGCmdLoadFromResource', 'SPVOICESTATUS',
    'SDA_Consume_Leading_Spaces', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRGetPropertyString', 'ISpGrammarBuilder',
    'SAFTCCITT_ALaw_8kHzStereo', 'SDTDisplayText',
    'SpeechTokenIdUserLexicon', 'ISpeechWaveFormatEx', 'SREPrivate',
    'ISpRecoGrammar', 'ISpProperties', 'DISPID_SWFEFormatTag',
    'SAFTADPCM_22kHzMono', 'SpeechInterference',
    '__MIDL_IWinTypes_0009', 'DISPID_SPAPhraseInfo',
    ...
    'SpVoice', 'SAFT48kHz8BitStereo', 'DISPID_SPRuleId',
    'eLEXTYPE_USER', 'SPPHRASEELEMENT', 'DISPID_SPIProperties',
    'SPSUnknown', 'DISPID_SPAs_NewEnum', 'SPEI_RESERVED5',
    'SPPHRASEPROPERTY', 'DISPID_SPAsCount', 'SPEI_SR_BOOKMARK',
    'SPSMF_UPS', 'SDTPronunciation', 'SPPROPERTYINFO',
    'DISPID_SGRSTsCount', 'DISPID_SGRSTsItem', 'eWORDTYPE_ADDED',
    'eLEXTYPE_PRIVATE17', 'DISPID_SLPs_NewEnum', 'ISpRecognizer',
    'SGRSTTWildcard', 'SpSharedRecognizer',
    'DISPID_SLWPronunciations', 'SPAS_PAUSE',
    'DISPID_SDKSetBinaryValue', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPCT_COMMAND', 'SpeechEmulationCompareFlags',
    'SRERecoOtherContext', 'ISpeechPhraseProperty',
    'SAFTExtendedAudioFormat', 'DISPID_SPCPhoneToId',
    'DISPID_SRGCmdLoadFromFile', 'SPPS_Interjection', 'SPGS_ENABLED',
    'SPCT_SUB_COMMAND', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPAUDIOSTATUS', 'DISPID_SVSInputWordPosition', 'SGRSTTWord',
    'SP_VISEME_17', 'SP_VISEME_8', 'SPBINARYGRAMMAR',
    'DISPID_SRCCreateGrammar', 'DISPID_SPEs_NewEnum',
    'DISPIDSPTSI_SelectionOffset', 'SPAO_NONE', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRRAudioFormat', 'DISPID_SPRuleName',
    'SAFT11kHz16BitMono', 'SpeechTokenShellFolder',
    'SPPS_SuppressWord', 'SRSInactive', 'DISPID_SpeechRecognizer',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SCSBaseStream', 'DISPID_SVEVoiceChange',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRCResume',
    'DISPID_SpeechDataKey', 'eLEXTYPE_PRIVATE8',
    'DISPID_SASCurrentDevicePosition', 'SAFT48kHz16BitStereo',
    'DISPID_SADefaultFormat', 'DISPID_SOTId', 'SAFT12kHz8BitStereo',
    'ISpEventSource', 'SDKLCurrentConfig', 'DISPID_SPELexicalForm',
    'DISPID_SOTGetDescription', 'SVSFlagsAsync', 'SPAR_Unknown',
    'ISpeechPhraseAlternates', 'DISPID_SpeechLexiconProns',
    'ISpeechLexiconWord', 'DISPID_SGRName', 'SP_VISEME_14',
    ...
    'SpeechUserTraining', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRCVoice', 'DISPID_SVEStreamEnd', 'SPFM_OPEN_READWRITE',
    'ISpVoice', 'DISPID_SLWType', 'SpeechRecoEvents',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRRSpeakAudio', 'SPFM_CREATE',
    'SAFT44kHz16BitStereo', 'SPPS_Function', 'SVP_4',
    'SpeechPartOfSpeech', 'SDTAll', 'SAFT16kHz16BitMono',
    'DISPID_SRGReset', 'DISPID_SGRsAdd', 'DISPID_SRRRecoContext',
    'DISPID_SPPFirstElement', 'DISPID_SPERetainedSizeBytes',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVSFUnusedFlags',
    'DISPID_SPRules_NewEnum', 'SpeechRegistryUserRoot',
    'DISPID_SRCEEndStream', 'DISPID_SDKGetStringValue',
    'DISPID_SpeechBaseStream', 'DISPID_SGRsItem',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPEDisplayAttributes',
    'eLEXTYPE_VENDORLEXICON', 'SPSVerb', 'DISPID_SpeechVoiceEvent',
    'SVSFNLPMask', 'SPINTERFERENCE_NOSIGNAL', 'SpeechLoadOption',
    'SVP_0', 'DISPID_SRRTOffsetFromStart', 'DISPID_SGRAttributes',
    'DISPID_SAFSetWaveFormatEx', 'SLTUser', 'eLEXTYPE_PRIVATE2',
    'SpPhoneConverter', 'ISpPhoneConverter', 'DISPID_SRSAudioStatus',
    'eLEXTYPE_PRIVATE18', 'DISPID_SLPType',
    'DISPID_SPEAudioTimeOffset', 'SPWORDTYPE', 'SVP_8',
    'SPINTERFERENCE_NOISE', 'SRATopLevel', 'ISpeechPhraseAlternate',
    'SSFMCreate', 'eLEXTYPE_PRIVATE13', 'SPPS_LMA', 'SGSExclusive',
    'SPVPRI_OVER', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SVRate', 'SP_VISEME_0', 'SAFTADPCM_44kHzStereo',
    'DISPID_SGRClear', 'UINT_PTR', 'SSSPTRelativeToStart',
    'SREAllEvents', 'SPPARTOFSPEECH', 'Speech_StreamPos_RealTime',
    'SpeechGrammarWordType', 'DISPID_SPEsCount', 'DISPID_SRCState',
    'SpFileStream', 'SREFalseRecognition', 'SpStreamFormatConverter',
    'STSF_AppData', 'DISPID_SPIGetText', 'SAFT8kHz16BitMono',
    'SPWT_LEXICAL', 'DISPID_SRCESoundStart', 'SpeechAudioState',
    'DISPID_SGRSAddRuleTransition',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVAlertBoundary',
    'SWPKnownWordPronounceable', 'SpeechCategoryAudioIn',
    'SpCompressedLexicon', 'DISPID_SPAsItem', 'SVEEndInputStream',
    'SPWF_INPUT', 'DISPID_SRGetPropertyNumber', 'eLEXTYPE_RESERVED8',
    'DISPID_SLWsItem', 'DISPID_SpeechLexiconWords',
    'SAFT32kHz8BitMono', 'ISpeechVoice', 'DISPID_SRGRules',
    'SPRECOCONTEXTSTATUS', 'SVP_2', 'SVP_17',
    'DISPID_SRGDictationLoad', 'DISPID_SOTCreateInstance',
    'DISPID_SDKEnumKeys', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SLGetPronunciations', 'DISPID_SPRuleNumberOfElements',
    'ISpPhrase', 'DISPID_SpeechPhraseInfo', 'ISpDataKey',
    'SAFTDefault', 'SPEI_MAX_TTS', 'SpeechRetainedAudioOptions',
    'SPWORDLIST', 'SAFT16kHz16BitStereo', 'DISPID_SVWaitUntilDone',
    'SINoise', 'SRTStandard', 'SpeechRuleAttributes', 'SPSFunction',
    'SPINTERFERENCE_TOOSLOW', 'SP_VISEME_18', 'SLTApp',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SpeechPhraseElement', 'SPSHT_OTHER', 'DISPID_SAFGuid',
    'DISPID_SMSALineId', 'DISPID_SVEventInterests',
    'ISpeechRecognizer', 'SpInprocRecognizer', 'SBOPause',
    'ISpStream', 'SASClosed', 'SVP_14', 'DISPID_SABufferInfo',
    'DISPID_SDKEnumValues', 'SPCT_DICTATION',
    'DISPID_SGRSTransitions', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SOTIsUISupported', 'DISPIDSPTSI_SelectionLength',
    'SINone', 'DISPID_SFSClose', 'SGDisplay', 'SPAS_STOP',
    'SPCS_DISABLED', '_ISpeechRecoContextEvents',
    'SPSHORTCUTPAIRLIST', 'SAFTADPCM_44kHzMono',
    'DISPID_SDKDeleteKey', 'SRESoundEnd', 'SPRULESTATE',
    'DISPID_SVVoice', 'DISPID_SpeechRecoResultTimes', 'SVPNormal',
    'ISpStreamFormat', 'DISPID_SGRId', 'DISPID_SpeechObjectToken',
    'DISPID_SVEBookmark', 'DISPID_SPISaveToMemory',
    'ISpeechAudioFormat', 'DISPID_SpeechLexiconWord',
    'DISPID_SPRFirstElement', 'DISPID_SPRsItem', 'SAFT22kHz8BitMono',
    'DISPID_SRRTimes', 'SPEI_PHONEME', 'SPWF_SRENGINE',
    'SDA_Two_Trailing_Spaces', 'DISPID_SPRNumberOfElements',
    'SpeechEngineProperties', 'SP_VISEME_13', 'SRAONone',
    'SAFTCCITT_ALaw_11kHzMono', 'SpInProcRecoContext',
    'DISPID_SASetState', 'DISPID_SRRAlternates',
    'SpeechAudioFormatGUIDWave', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SVSInputSentencePosition', 'SAFT11kHz16BitStereo',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPIGrammarId',
    'SPRECORESULTTIMES', 'DISPID_SOTsItem', 'DISPID_SPCIdToPhone',
    'SpeechAudioVolume', 'DISPID_SPIRule', 'STCInprocHandler',
    'ISpObjectWithToken', 'DISPID_SRCRecognizer',
    'DISPID_SREmulateRecognition', 'IStream', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRAudioInputStream', 'SpeechStreamSeekPositionType',
    'SREAudioLevel', 'DISPID_SPEActualConfidence', 'SVP_18',
    'DISPID_SLPsCount', 'DISPID_SOTsCount', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFTGSM610_8kHzMono', 'SGPronounciation', 'SAFTText',
    'DISPID_SVAudioOutputStream', 'DISPID_SGRSRule',
    'DISPID_SpeechVoice', 'DISPID_SLPsItem',
    'DISPID_SpeechPhraseBuilder', 'SECFNoSpecialChars',
    'DISPID_SRCERequestUI', 'SPRST_INACTIVE', 'SRTExtendableParse',
    'DISPID_SRRPhraseInfo', 'SPSNoun', 'DISPID_SpeechObjectTokens',
    'ISpeechPhraseInfo', 'DISPID_SAStatus', 'eLEXTYPE_MORPHOLOGY',
    'SpeechWordType', '_SPAUDIOSTATE', 'SPFM_CREATE_ALWAYS',
    'STSF_FlagCreate', 'eLEXTYPE_PRIVATE10', 'SpPhraseInfoBuilder',
    'SDKLLocalMachine', 'SWPUnknownWordPronounceable', 'SVP_13',
    'DISPID_SRCEHypothesis', 'SP_VISEME_16', 'SpLexicon',
    'eLEXTYPE_RESERVED6', 'SpeechAddRemoveWord', 'SpeechTokenContext',
    'ISpeechObjectToken', 'DISPID_SRSCurrentStreamPosition', 'SVP_3',
    'eLEXTYPE_RESERVED10', 'DISPID_SPIReplacements',
    'STCRemoteServer', 'ISpNotifySink', 'DISPID_SRSClsidEngine',
    'SRARoot', 'SAFT24kHz16BitMono', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpeechRecoGrammar', 'SRSEIsSpeaking', 'ISpeechPhraseElements',
    'SPWAVEFORMATTYPE', 'DISPID_SGRsCount', 'SAFT11kHz8BitMono',
    'ISpeechAudioBufferInfo', 'SpeechGrammarTagDictation',
    'DISPID_SPEEngineConfidence', 'SpShortcut', 'DISPID_SPIStartTime',
    'SPBO_AHEAD', 'DISPIDSPTSI_ActiveLength', 'SpMemoryStream',
    'DISPID_SRCESoundEnd', 'SAFTCCITT_uLaw_44kHzMono', 'SREBookmark',
    'SPINTERFERENCE_TOOFAST', 'SPAS_CLOSED', 'ISpeechRecoResult2',
    'SPPS_Noncontent', 'SVP_6', 'SECNormalConfidence', 'SPAR_High',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SAEventHandle',
    'SpMMAudioIn', 'SPVISEMES', 'SREAdaptation',
    'DISPID_SGRInitialState', 'DISPID_SPIRetainedSizeBytes',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SABIBufferSize',
    'SREInterference', 'SPDKL_CurrentConfig',
    'DISPID_SVEEnginePrivate', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRCCmdMaxAlternates', 'SVSFIsNotXML', 'SPAR_Medium',
    'ISpeechMemoryStream', '_RemotableHandle', 'SpNullPhoneConverter',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPRuleChildren',
    'DISPID_SMSADeviceId', 'DISPID_SRCVoicePurgeEvent',
    'SPWORDPRONUNCIATION', 'ISpeechXMLRecoResult',
    'SpeechAudioProperties', 'DISPID_SRCEAudioLevel',
    'DISPID_SRRAudio', 'SPSEMANTICERRORINFO', 'SP_VISEME_20',
    'SpeechCategoryAudioOut', 'DISPID_SVDisplayUI',
    ...
    'SAFT24kHz16BitStereo', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechCustomStream', 'SPEI_END_SR_STREAM',
    'DISPID_SPRulesCount', 'SVP_12', 'DISPID_SpeechPhraseAlternate',
    'SpeechPropertyAdaptationOn', 'DISPID_SVPriority',
    'SAFTGSM610_22kHzMono', 'SPEVENTENUM', 'SAFTCCITT_uLaw_11kHzMono',
    'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPFILEMODE',
    'ISpResourceManager', 'DISPID_SWFEBitsPerSample',
    'SpPhoneticAlphabetConverter', 'SVSFDefault', 'SVPAlert',
    'SpTextSelectionInformation', 'DISPID_SpeechRecoContextEvents',
    'SVEPrivate', 'DISPID_SGRsCommit', 'SPPS_Unknown',
    'DISPID_SOTGetAttribute', 'DISPID_SBSFormat',
    'SREPropertyStringChange', 'DISPID_SRGSetWordSequenceData',
    'ISpXMLRecoResult', 'SPEI_VISEME', 'SAFTCCITT_ALaw_44kHzStereo',
    'SRESoundStart', 'IEnumString', 'SPSHORTCUTTYPE',
    'STSF_LocalAppData', 'DISPID_SPIEnginePrivateData',
    'SAFT32kHz16BitStereo', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTADPCM_11kHzMono', 'SPPS_Modifier'
]
